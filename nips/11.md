...
An alternative contact may be listed under the `email` field as well, with the same purpose as `pubkey`.  Use of a Nostr public key and direct message SHOULD be preferred over email.
